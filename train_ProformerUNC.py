...
from trainer.trainer_ProformerUNC import Trainer_ProformerUNC
...
def main(config):
    ...
    if config['trainer']['criterion']=='GEV':
        criterion = None
    # criterion = None
    trainer = Trainer_ProformerUNC(model_G0,model_G1, model_G2, model_G3, model_G4, model_G5, model_G6,
                        data_loader, 
                        valid_data_loader, 
                        criterion, 
                        metrics, 
...
if __name__ == '__main__':
    ...
    options = [
        ...
        CustomArgs(['--D_MOD', '--D_MODEL'], type=int, target='arch_G0;args;d_model'),
